...
이 포스트는 **리액트 훅 시리즈** 중 하나다. [useState 원리](/dev/2025-08-04-usestate-principle.html), [useEffect](/dev/2025-08-06-useeffect.html)에 이어 `useReducer`를 정리했다. 다음에는 `useRef`, `useCallback` 등으로 이어갈 예정이다.
